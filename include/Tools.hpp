...
class Tools{  
    public:  
        ...
        double beam_widening_earth_space(double wavelength, std::vector<double> sectors, double distance, double wind_speed, double zenith);
        double beam_widening_space_earth(double wavelength, std::vector<double> sectors, double distance, double wind_speed, double zenith);
};
