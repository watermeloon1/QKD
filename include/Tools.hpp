...
class Tools{  
    public:  
        ...
        double turbulence_strength(double height_above_sea_level, double windspeed);
        ...
        double beam_widening_earth_space(double wavelength, std::vector<double> sectors, double distance, double windspeed, double zenith);
        double beam_widening_space_earth(double wavelength, std::vector<double> sectors, double distance, double windspeed, double zenith);
};
